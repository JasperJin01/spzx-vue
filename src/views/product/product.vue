  ...
  <div>
    ...
    <el-table :data="list" style="width: 100%">
      ...
      <el-table-column label="操作" align="center" width="200" #default="scope">
        <el-button type="primary" size="small" style="padding: 5px; margin-left: 5px"
          @click="editShow(scope.row)">
          修改
        </el-button>
        <el-button type="danger" size="small" style="padding: 5px; margin-left: 5px"
          @click="remove(scope.row.id)">
          删除
        </el-button>
        <el-button
          v-if="scope.row.auditStatus == 0 || scope.row.auditStatus == -1"
          type="success" size="small" style="padding: 5px; margin-left: 5px"
        ...
        <el-button
          v-if="
            ...
            scope.row.status == 0
          "
          type="warning" size="small" style="padding: 5px; margin-left: 5px"
    ...
    <el-dialog v-model="dialogAuditVisible" title="审批" width="80%">
      <el-form :model="product" label-width="120px" style="margin-top: 10px">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="分类">
              {{ product.category1Name }} => {{ product.category2Name }} => {{ product.category3Name }}
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item label="状态">
              {{ product.auditStatus == 0 ? '未审核' : product.auditStatus == 1 ? '通过' : '驳回' }}
            </el-form-item>
          </el-col>
        </el-row>
        <el-row>
